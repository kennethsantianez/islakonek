							...
							<tr>
								<td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
									<div class="inline-flex items-center gap-x-3">
										...
										<div class="flex items-center gap-x-2">
											<img class="object-cover w-10 h-10 rounded-full" src="{{ ($user->media[0]) ? $user->media[0]->getUrl() : '' }}" alt="">
											<div>
								...
								<td class="px-4 py-4 text-sm whitespace-nowrap">
									<div class="flex items-center gap-x-6">
										...
										{{-- delete --}}
										<button wire:click="$dispatch('delete-user', { userId: {{ $user->id }} })" class="text-gray-500 transition-colors duration-200 dark:hover:text-red-500 dark:text-gray-300 hover:text-red-500 focus:outline-none">
