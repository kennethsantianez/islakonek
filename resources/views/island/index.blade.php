						...
						<div class="sm:flex sm:items-center sm:justify-between">
							<div>
								<div class="flex items-center gap-x-3">
									<h2 class="text-lg font-medium text-gray-800 dark:text-white">Islands</h2>
								...
								<p class="mt-1 text-sm text-gray-500 dark:text-gray-300">These are all the Islands registered in the
									system.</p>
							</div>
